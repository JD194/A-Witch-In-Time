...
public class CreateWaterSpell : MonoBehaviour
{
    public GameObject player;
    public GameObject waterCreator;
    ...
    {
        if (!player.GetComponent<TestController>().waterCreateActive && castForHand.mana + spellCost >= 0)
        {
            player.GetComponent<TestController>().waterCreateActive = true;
            waterCreator.SetActive(true);
